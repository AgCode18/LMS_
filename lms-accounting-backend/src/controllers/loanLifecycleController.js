...
// export const disburse = asyncHandler(
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.disburseLoan({ 
...
// export const collectEmi = asyncHandler(
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.collectEmi({ 
//       emiScheduleId: req.params.emiScheduleId, 
//       ...req.body 
//     });
//     res.status(201).json(result);
//   }
...
// export const collectPenalty = asyncHandler(
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.collectPenalty({ 
//       loanApplicationId: req.params.id, 
//       ...req.body 
//     });
//     res.status(201).json(result);
...
// export const chargeProcessingFee = asyncHandler(
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.chargeProcessingFee({ 
//       loanApplicationId: req.params.id, 
//       ...req.body 
//     });
//     res.status(201).json(result);
...
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.writeOffLoan({ 
//       loanApplicationId: req.params.id, 
//       ...req.body 
//     });
//     res.status(201).json(result);
...
//   async (req: Request, res: Response) => {
//     const result = await lifecycle.recordRecoveryPayment({ 
//       loanRecoveryId: req.params.loanRecoveryId, 
//       ...req.body 
//     });
//     res.status(201).json(result);
//   }
