...
//       const data: any = await bankReconciliation(accountId as string, {
//         statementDate: statementDate as string,
//         from: from as string,
//         to: to as string,
//       });
...
//       await sendExport(res, format as string, 'bank-reconciliation', title, columns, rows, subtitle);
//     } catch (error) {
//       next(error);
//     }
//   },

//   async setLineCleared(
